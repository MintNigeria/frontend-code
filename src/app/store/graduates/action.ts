...
export const downloadTalentSearchReportExcel = createAction(
  '[graduates] download talent search report for organization Excel File',
  props<{
    payload: any
  }>()
);
export const downloadTalentSearchReportExcelSuccess = createAction(
  '[graduates] download talent search report for organization Excel File success',
  props<{
    payload: any
  }>()
); 

export const downloadTalentSearchReportCSV = createAction(
  '[graduates] download talent search report for organization CSV File',
  props<{
    payload: any
  }>()
);
export const downloadTalentSearchReportCSVSuccess = createAction(
  '[graduates] download talent search report for organization CSV File success',
  props<{
    payload: any
  }>()
); 