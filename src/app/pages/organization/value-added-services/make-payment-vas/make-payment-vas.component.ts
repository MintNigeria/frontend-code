...
@Component({
  selector: 'app-make-payment-vas',
  templateUrl: './make-payment-vas.component.html',
  styleUrls: ['./make-payment-vas.component.scss']
})
export class MakePaymentVasComponent implements OnInit {
